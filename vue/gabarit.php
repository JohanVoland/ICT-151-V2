            ...
            <div class="nav-collapse collapse">
              <ul class="nav nav-pills ddmenu">
                ...
                <?php endif; ?>
                  ...
                  <!-- Si un utilisateur est déjà connecté ou pas, switch entre login ou logout-->
                  ...
                  <!-- Si un utilisateur est connecté ou pas, affiche ou non le panier -->
                  <li <?php if(@$_GET['action']== "vue_panier") echo 'class="active"'; ?>>
                          <?php if (isset($_SESSION['login'])) :?>
                              <a href="index.php?action=vue_panier">Panier</a>
                      <?php endif ?>
                  </li>
